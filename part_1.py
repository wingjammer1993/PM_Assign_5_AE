...
with pm.Model() as dna_model:
    ...
    # If g1 = 0, g2 = 1 with probability 0.1 and g2 = 0 with probability 0.9
    # If g1 = 1, g2 = 1 with probability 0.9 and g2 = 0 with probability 0.1
    g2 = pm.Bernoulli('g2', pm.math.switch(g1 < 1, 0.1, 0.9))

    # Create a variable g3 with Bernoulli distribution.
    # If g1 = 0, g3 = 1 with probability 0.1 and g3 = 0 with probability 0.9
    # If g1 = 1, g3 = 1 with probability 0.9 and g3 = 0 with probability 0.1
